...
ubuntu1804.exe run "hostip=$(cat /etc/resolv.conf | grep nameserver | awk '{print $2}') ; export LIBGL_ALWAYS_INDIRECT=1 ; export DISPLAY=$hostip:0 ; export PULSE_SERVER=tcp:$hostip ; startlxde ; pkill '(gpg|ssh)-agent' ;"
